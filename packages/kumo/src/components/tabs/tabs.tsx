    ...
    >
      ...
      <TabsPrimitive.List
        ...
        className={cn(
          ...
          isSegmented &&
            "h-8.5 rounded-lg bg-kumo-surface ring-[0.4px] ring-kumo-ring p-0",
      ...
      >
        ...
        <TabsPrimitive.Indicator
          className={cn(
            ...
            isSegmented &&
              "top-(--active-tab-top) h-(--active-tab-height) rounded-lg bg-kumo-overlay shadow-sm ring ring-kumo-ring",
